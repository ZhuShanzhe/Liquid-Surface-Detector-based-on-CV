...
生成 1472 张 RGB-D 图像，评估 5248 帧条件组合；10607 为开发场景种子，10709 为独立检查种子。三个传感器族使用项目已有噪声和错误回波仿真参数，不能等同于真实设备认证。
...
|---:|---:|---|---|---|
| 0.1 | 0.1 | 0.0% / - | 0.0% / - | 100.0% / 0.05 |
| 0.2 | 0.1 | 100.0% / 0.03 | 100.0% / 0.04 | 100.0% / 0.05 |
| 0.5 | 0.3 | 100.0% / 0.09 | 100.0% / 0.18 | 100.0% / 0.12 |
| 1 | 0.3 | 100.0% / 0.28 | 9.1% / 1.19 | 100.0% / 0.07 |
| 1 | 3 | 100.0% / 0.32 | 0.0% / - | 100.0% / 0.07 |
| 2 | 1 | 0.0% / - | 0.0% / - | 100.0% / 0.10 |
| 3 | 0.1 | 0.0% / - | 0.0% / - | 100.0% / 0.16 |
| 4 | 3 | 0.0% / - | 0.0% / - | 100.0% / 0.19 |
| 6 | 0.3 | 0.0% / - | 0.0% / - | 100.0% / 0.13 |
| 6 | 5 | 0.0% / - | 0.0% / - | 100.0% / 0.17 |
| 8 | 8 | 0.0% / - | 0.0% / - | 100.0% / 0.38 |
| 10 | 10 | 0.0% / - | 0.0% / - | 0.0% / - |
...
|---|---:|---:|---:|---:|
| 0.1/0.1 | 90.91% | 9.1% | 0.00% | 0.10 |
| 0.2/0.1 | 90.91% | 9.1% | 0.00% | 0.10 |
| 0.5/0.3 | 81.82% | 18.2% | 0.00% | 0.20 |
| 1/0.3 | 81.82% | 27.3% | 33.33% | 0.30 |
| 1/3 | 0.00% | 100.0% | 0.00% | - |
| 2/1 | 72.73% | 27.3% | 0.00% | 0.30 |
| 3/0.1 | 100.00% | 18.2% | 100.00% | 0.20 |
| 4/3 | 54.55% | 45.5% | 0.00% | 0.50 |
| 6/0.3 | -% | 0.0% | -% | 0.20 |
| 6/5 | -% | 9.1% | 0.00% | 0.50 |
| 8/8 | -% | 9.1% | 0.00% | 0.70 |
| 10/10 | -% | 0.0% | -% | - |
...
|---|---:|---:|---:|---:|
| recovery_static/recovery | 100.0% | 66.7% | 0.40 | 0.05 |
| recovery_static/recovery_bad_echo | 0.0% | 0.0% | - | - |
| recovery_changed/recovery | 0.0% | 66.7% | 0.40 | 0.08 |
| recovery_changed/recovery_bad_echo | 0.0% | 0.0% | - | - |
...
共 1644 帧。原路径覆盖率 44.83%，越界占已输出比例 15.06%；新路径覆盖率 37.10%，越界占已输出比例 0.82%。
改善主要来自拒绝不可靠结果，不能据此宣称全量程高覆盖已达标。
长时失效测试目前仅覆盖 6 秒（60 帧）中断，以及中断期间 4 cm 液位变化；不证明分钟/小时级遮挡、外观变化或相机重新定位已通过验证。

新路径 GPU 模型＋独立 RGB 校验＋时序几何的处理 P95 约 14.27 ms；不包含相机采集、磁盘输入、真实位姿求解和显示。模型权重没有重新训练。
