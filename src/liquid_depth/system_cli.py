...
def _setup(args) -> None:
    ...
    profile = {
        ...
        "temporal": {
            ...
            "anchor_memory": {
                "enabled": True,
                "activation_valid_ratio_below": 0.45,
                "max_age_frames": 45,
                "max_history_frames": 12,
                "min_confidence": 0.55,
                "confidence_decay": 0.94,
                "memory_confidence_cap": 0.82,
                "spatial_match_px": 10.0,
                "max_model_match_px": 8.0,
                "flow_window_px": 21,
                "max_flow_error_px": 12.0,
                "max_pose_flow_disagreement_px": 8.0,
                "rgb_sigma_lab": 32.0,
                "min_rgb_similarity": 0.18,
